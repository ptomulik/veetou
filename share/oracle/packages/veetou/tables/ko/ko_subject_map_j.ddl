CREATE TABLE v2u_ko_subject_map_j
    (
        ...
        , CONSTRAINT v2u_ko_subject_map_j_pk PRIMARY KEY (subject_map_id, subject_issue_id, job_uuid)
        ...
        , CONSTRAINT v2u_ko_subject_map_j_f2 FOREIGN KEY (subject_issue_id, job_uuid) REFERENCES v2u_ko_subject_issues(id, job_uuid)
    );
