CREATE TABLE v2u_ko_student_specialties_j
    (
        ...
        , sheet_id NUMBER(38)
        , CONSTRAINT v2u_ko_student_specs_j_pk PRIMARY KEY (specsem_id, student_id, job_uuid)
        , CONSTRAINT v2u_ko_student_specs_j_f0 FOREIGN KEY (job_uuid) REFERENCES v2u_ko_jobs(job_uuid)
        , CONSTRAINT v2u_ko_student_specs_j_f1 FOREIGN KEY (specsem_id, job_uuid) REFERENCES v2u_ko_specialty_semesters_j(id, job_uuid)
