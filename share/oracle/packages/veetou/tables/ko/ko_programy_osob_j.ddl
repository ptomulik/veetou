CREATE TABLE v2u_ko_programy_osob_j
    (
          id NUMBER(38)
        , job_uuid RAW(16)
...
NESTED TABLE semester_ids STORE AS v2u_ko_prgos_semesters_nt
    ...
    ;
/
CREATE SEQUENCE v2u_ko_programy_osob_j_sq1 START WITH 1;
/
CREATE OR REPLACE TRIGGER v2u_ko_programy_osob_j_tr1
    BEFORE INSERT ON v2u_ko_programy_osob_j
    FOR EACH ROW
    WHEN (new.id IS NULL)
    BEGIN
        SELECT v2u_ko_programy_osob_j_sq1.NEXTVAL INTO :new.id FROM dual;
    END;
