...
OF V2u_Ko_Subject_Semester_J_t
    (
          CONSTRAINT v2u_ko_subject_semesters_j_pk PRIMARY KEY (job_uuid, semester_id, specialty_id, subject_id)
        ...
        , CONSTRAINT v2u_ko_subject_semesters_j_f4 FOREIGN KEY (job_uuid, semester_id, specialty_id)
