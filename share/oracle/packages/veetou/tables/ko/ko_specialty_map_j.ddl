CREATE TABLE v2u_ko_specialty_map_j
    (
        ...
        , CONSTRAINT v2u_ko_specialty_map_j_pk PRIMARY KEY (specialty_map_id, specialty_issue_id, job_uuid)
        ...
        , CONSTRAINT v2u_ko_specialty_map_j_f2 FOREIGN KEY (specialty_issue_id, job_uuid) REFERENCES v2u_ko_specialty_issues(id, job_uuid)
    );
