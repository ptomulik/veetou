CREATE TABLE v2u_ko_specialty_map_j
    (
        ...
        , CONSTRAINT v2u_ko_specialty_map_j_pk PRIMARY KEY (specmap_id, specent_id, job_uuid)
        ...
        , CONSTRAINT v2u_ko_specialty_map_j_f2 FOREIGN KEY (specent_id, job_uuid) REFERENCES v2u_ko_specialty_entities(id, job_uuid)
    );
