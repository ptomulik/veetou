CREATE TABLE v2u_ko_matched_proto_j
OF V2u_Ko_Matched_Proto_J_t
    (
        ...
        , CONSTRAINT v2u_ko_matched_proto_j_f6
...
;
/
CREATE INDEX v2u_ko_matched_proto_j_idx1
    ON v2u_ko_matched_proto_j(subject_id, specialty_id, semester_id, job_uuid);
