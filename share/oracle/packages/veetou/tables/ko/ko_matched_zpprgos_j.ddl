CREATE TABLE v2u_ko_matched_zpprgos_j
OF V2u_Ko_Matched_Zpprgos_J_t
    (
        -- PK

          CONSTRAINT v2u_ko_matched_zpprgos_j_pk
            PRIMARY KEY ( os_id
                        , cdyd_kod
                        , prz_kod
                        , prgos_id
        ...
        , CONSTRAINT v2u_ko_matched_zpprgos_j_f5
...
;
/
CREATE INDEX v2u_ko_matched_zpprgos_j_idx1
    ON v2u_ko_matched_zpprgos_j(student_id, subject_id, specialty_id, semester_id, job_uuid);
/
