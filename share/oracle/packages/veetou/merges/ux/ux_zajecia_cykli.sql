    ...
    (
        ...
        (
            ...
            LEFT JOIN v2u_ko_classes_map_j cm_j
                ON (cm_j.subject_id = ss_j.subject_id AND
                    cm_j.specialty_id = ss_j.specialty_id AND
                    cm_j.semester_id = ss_j.semester_id AND
                    cm_j.job_uuid = ss_j.job_uuid AND
                    cm_j.selected = 1)
            ...
            LEFT JOIN v2u_ko_matched_zajcykl_j ma_j
                ON (ma_j.subject_id = ss_j.subject_id AND
                    ...
                    ma_j.job_uuid = ss_j.job_uuid AND
                    ma_j.classes_type = cm_j.classes_type)
            LEFT JOIN v2u_ko_missing_zajcykl_j mi_j
                ON (mi_j.subject_id = ss_j.subject_id AND
                    ...
                    mi_j.job_uuid = ss_j.job_uuid AND
                    mi_j.classes_type = cm_j.classes_type)
