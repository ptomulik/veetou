...
WHEN NOT MATCHED THEN
    INSERT (    job_uuid,     student_id,     specialty_id,     semester_id,     tried_specialty_map_ids)
    VALUES (src.job_uuid, src.student_id, src.specialty_id, src.semester_id, src.tried_specialty_map_ids)
