...
WHEN NOT MATCHED THEN
    INSERT (    job_uuid,     subject_id,     specialty_id,     semester_id,     map_id,     matching_score,     highest_score,     selected,     reason)
    VALUES (src.job_uuid, src.subject_id, src.specialty_id, src.semester_id, src.map_id, src.matching_score, src.highest_score, src.selected, src.reason)
WHEN MATCHED THEN
    UPDATE SET
