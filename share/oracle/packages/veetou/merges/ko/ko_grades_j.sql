...
USING
    (
        ...
        INNER JOIN v2u_ko_subject_trs_j subject_trs
            ON (subject_trs.tr_id = trs.id AND
                subject_trs.job_uuid = trs.job_uuid)
...
WHEN NOT MATCHED THEN
    INSERT (    job_uuid,     student_id,     subject_id,     specialty_id,     semester_id,      subj_grade,     subj_grade_date,     tr_id)
