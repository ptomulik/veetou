    ...
    (
        ...
        ( -- add extra fields
            SELECT
                ...
                , subj_map_j.matching_score subject_matching_score
                , subject_map.map_subj_code
                -- FIXME: istniejace wpisy punkty_przedmiotow ...
                , subjects.subj_code
            ...
            LEFT JOIN v2u_ko_subject_map_j subj_map_j
                ON  (
                            subj_map_j.subject_id = u.subject_id
                        AND subj_map_j.specialty_id = u.specialty_id
                        AND subj_map_j.semester_id = u.semester_id
                        AND subj_map_j.job_uuid = u.job_uuid
