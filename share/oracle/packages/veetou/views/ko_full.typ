CREATE OR REPLACE TYPE Veetou_Ko_Full_Typ FORCE AUTHID CURRENT_USER AS OBJECT
    ...
    , page_id NUMBER(38)
    , page_page_number NUMBER(16)
    , page_parser_page_number NUMBER(16)
    , sheet_id NUMBER(38)
    , sheet_pages_parsed NUMBER(4)
    , sheet_first_page NUMBER(16)
    , sheet_ects_mandatory NUMBER(16)
    , sheet_ects_other NUMBER(16)
    , sheet_ects_total NUMBER(16)
    , sheet_ects_attained NUMBER(16)
    , report_id NUMBER(38)
    , report_source VARCHAR(512 CHAR)
    , report_datetime TIMESTAMP
    , report_first_page NUMBER(16)
    ...
    , preamble_semester_number NUMBER(4)
    ...
    , footer_sheet_page_number NUMBER(16)
    , footer_sheet_pages_total NUMBER(16)
