CREATE OR REPLACE VIEW veetou_ko_x_trs_ov
AS SELECT
...
INNER JOIN veetou_ko_report_sheets report_sheets
      ON (report_sheets.job_uuid = sheets.job_uuid AND
          report_sheets.ko_sheet_id = sheets.id)
INNER JOIN veetou_ko_reports_ov reports
...
INNER JOIN veetou_ko_page_footer page_footer
      ON (page_footer.job_uuid = pages.job_uuid AND
          page_footer.ko_page_id = pages.id)
INNER JOIN veetou_ko_footers_ov footers
