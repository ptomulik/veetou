CREATE OR REPLACE TYPE V2u_Uu_Classes_Grade_t
    ...
    , v2u_classes_type VARCHAR2(1 CHAR)
    , v2u_map_classes_type VARCHAR(3 CHAR)
    , v2u_classes_hours NUMBER(8)
    ...
    , CONSTRUCTOR FUNCTION V2u_Uu_Classes_Grade_t(
              SELF IN OUT NOCOPY V2u_Uu_Classes_Grade_t
            , v2u_job_uuid IN RAW
