CREATE OR REPLACE TYPE BODY V2u_Ko_Ambig_Specialty_Map_t AS
    CONSTRUCTOR FUNCTION V2u_Ko_Ambig_Specialty_Map_t(
          SELF IN OUT NOCOPY V2u_Ko_Ambig_Specialty_Map_t
        , job_uuid IN RAW
    ...
    ORDER MEMBER FUNCTION cmp_with(
              other V2u_Ko_Ambig_Specialty_Map_t
            ) RETURN INTEGER
    IS
        ord INTEGER;
    BEGIN
