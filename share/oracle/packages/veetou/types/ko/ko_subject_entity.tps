CREATE OR REPLACE TYPE V2u_Ko_Subject_Entity_t FORCE AUTHID CURRENT_USER AS OBJECT
    ( job_uuid RAW(16)
    , id NUMBER(38)
    ...
    , CONSTRUCTOR FUNCTION V2u_Ko_Subject_Entity_t(
              SELF IN OUT NOCOPY V2u_Ko_Subject_Entity_t
            , job_uuid IN RAW
            , id IN NUMBER := NULL
