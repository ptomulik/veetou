CREATE OR REPLACE TYPE BODY V2u_Ko_Grade_t AS
    CONSTRUCTOR FUNCTION V2u_Ko_Grade_t(
          SELF IN OUT NOCOPY V2u_Ko_Grade_t
        , job_uuid IN RAW
    ...
    ORDER MEMBER FUNCTION cmp(other V2u_Ko_Grade_t)
        RETURN INTEGER
    IS
        ord INTEGER;
    BEGIN
