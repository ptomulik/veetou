CREATE OR REPLACE TYPE V2u_Ko_Matched_Przcykl_t
    ...
    , CONSTRUCTOR FUNCTION V2u_Ko_Matched_Przcykl_t(
              SELF IN OUT NOCOPY V2u_Ko_Matched_Przcykl_t
            , id IN NUMBER
            , job_uuid IN RAW
...
/
CREATE OR REPLACE TYPE V2u_Ko_Matched_Przcykles_t
    AS TABLE OF V2u_Ko_Matched_Przcykl_t;
