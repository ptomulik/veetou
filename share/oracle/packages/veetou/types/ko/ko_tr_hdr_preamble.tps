CREATE OR REPLACE TYPE V2u_Ko_Tr_Hdr_Preamble_t FORCE AUTHID CURRENT_USER AS OBJECT
    ( job_uuid RAW(16)
    , id NUMBER(38)
    , tr REF V2u_Ko_Tr_t
...
/
CREATE OR REPLACE TYPE V2u_Ko_Tr_Hdr_Preambles_t
    AS TABLE OF V2u_Ko_Tr_Hdr_Preamble_t;
