CREATE OR REPLACE TYPE BODY V2u_Ko_Subject_Semester_U_t AS
    CONSTRUCTOR FUNCTION V2u_Ko_Subject_Semester_U_t(
              SELF IN OUT NOCOPY V2u_Ko_Subject_Semester_U_t
