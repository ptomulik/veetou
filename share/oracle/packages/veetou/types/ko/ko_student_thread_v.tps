CREATE OR REPLACE TYPE V2u_Ko_Student_Thread_V_t
    ...
    , CONSTRUCTOR FUNCTION V2u_Ko_Student_Thread_V_t(
              SELF IN OUT NOCOPY V2u_Ko_Student_Thread_V_t
            , job_uuid IN RAW
    ...
    , ORDER MEMBER FUNCTION cmp(other IN V2u_Ko_Student_Thread_V_t)
            RETURN INTEGER
    );
/
CREATE OR REPLACE TYPE V2u_Ko_Student_Threads_V_t
    AS TABLE OF V2u_Ko_Student_Thread_V_t;
