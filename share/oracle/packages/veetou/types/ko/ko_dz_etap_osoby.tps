CREATE OR REPLACE TYPE V2u_Ko_Dz_Etap_Osoby_t
    ...
    , CONSTRUCTOR FUNCTION V2u_Ko_Dz_Etap_Osoby_t(
              SELF IN OUT NOCOPY V2u_Ko_Dz_Etap_Osoby_t
            , job_uuid IN RAW
            , id IN NUMBER
...
--    , ORDER MEMBER FUNCTION cmp(other IN V2u_Ko_Dz_Etap_Osoby_t)
--            RETURN INTEGER
    );
/
CREATE OR REPLACE TYPE V2u_Ko_Dz_Etapy_Osob_t
    AS TABLE OF V2u_Ko_Dz_Etap_Osoby_t;
